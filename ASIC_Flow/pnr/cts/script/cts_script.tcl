...
set_clock_routing_rules -net_type root -clocks {CLK} -rules clk_network_NDR_root -max_routing_layer M7 -min_routing_layer M5
set_clock_routing_rules -net_type internal -clocks {CLK} -rules clk_network_NDR_internal -max_routing_layer M5 -min_routing_layer M3
set_clock_routing_rules -net_type sink -clocks {CLK} -default_rule  -max_routing_layer M3 -min_routing_layer M1
...
set_max_capacitance 100 -clock_path [get_clocks {CLK}] 
